        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" id="adminForm" action="{{ route('admin.admins.store') }}">
                @csrf
                <div class="card-body">

                    <div class="form-group">
                        <label for="first_name">{{ __('First Name') }}:<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="first_name" id="first_name" placeholder="{{ __('First Name') }}" value="{{ old('first_name') }}">
                    </div>
                    <div class="form-group">
                        <label for="last_name">{{ __('Last Name') }}:<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="last_name" id="last_name" placeholder="{{ __('Last Name') }}" value="{{ old('last_name') }}">
                    </div>
                    <div class="form-group">
                        <label for="username">{{ __('Username') }}:<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="username" id="username" placeholder="{{ __('Username') }}" value="{{ old('username') }}">
                    </div>
                    <div class="form-group">
                        <label for="email">{{ __('Email Address') }}:<span class="text-danger">*</span></label>
                        <input type="email" class="form-control" name="email" id="email" placeholder="{{ __('Email Address') }}" value="{{ old('email') }}">
                    </div>                  
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="phone" class="form-control" name="phone" id="phone" placeholder="{{ __('Phone') }}" autocomplete="false" value="{{ old('phone') }}">
                    </div>
                    <div class=" form-group">
                    ...
                    <div class=" form-group">
                        ...
                        <input id="address_line2" name="address_line2" type="text" class="form-control" placeholder="Address Line2" value="{{ old('address_line2') }}">
                    </div>
                    <div class=" form-group">
                    ...
                    <div class=" form-group">
                        ...
                        <select id="status" name="status" class="custom-select rounded-0" id="exampleSelectRounded0">
                            <option value="1" {{(old('status', 1) === 1) ? 'selected="selected"':''}}>{{ __('Active') }}</option>
                            <option value="0" {{(old('status') === 0) ? 'selected="selected"':''}} >{{ __('Inactive') }}</option>
                        </select>
                    </div>
